  ...
  return (
    <div className={highScreen ? styles.container_span : styles.container_flow}>
      ...
      </header>
      {
        ...
        : <div className={[styles.flex_flow].join(' ')} style={ fullScreen ? { width: '100%' } : { width: '22rem', alignSelf: 'center'} }>
      ...
      <div className={styles.back_footer} style={ fullScreen ? { width: '100%' } : { width: '22rem', alignSelf: 'center'} }>
        {!!home && (
